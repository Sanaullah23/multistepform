  ...
  return (
    ...
    <div className='w-[520px] mx-auto flex  mt-[100px] flex-col  justify-center   gap-6'>
     <div>
         ...
         <div>
          <h1 className='text-[28px] font-medium text-center'> Your Request for a Proposal Has Been Submitted!</h1>
    ...
    <Link to='/home' className="bg-green-700 hover:bg-green-600 text-white font-medium py-3 px-6 mx-auto"> <button
